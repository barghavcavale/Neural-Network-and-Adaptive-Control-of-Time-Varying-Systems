...
from Train1Layer_2A import Train 
...
def Run(mu):
	...
	pickle_out=open("BPA1Layer_2A_yphat.pickle","wb")
	pickle.dump(yphat,pickle_out)
	pickle_out.close()
	pickle_out=open("BPA1Layer_2A_J.pickle","wb")
	...
	# plt.xlabel("Time")
	# plt.ylabel("Val")
	# plt.title("2 A Time-Varying 1 Layer BPA mu = "+str(mu))
	# plt.show()
